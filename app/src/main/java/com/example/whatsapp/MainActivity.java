...
//        setOnlineStatus("online");
        ...
        database.getReference().child("Users").child(auth.getUid()).child("incomingVideoCall").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!Objects.equals(callerId, "null")) {
                    ...
                    Intent intent = new Intent(MainActivity.this, VideoCallReceiveActivity.class);
